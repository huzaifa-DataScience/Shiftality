...
const [dndEnd, setDndEnd] = useState(() => {
  ...
  <View style={{ alignItems: 'center', marginVertical: s(15) }}>
    <Text style={styles.Sectitle}>{"Your 1-Year Shadow Path (What\nYou're Shifting Away From) *"}</Text>
  </View>
...
<GradientCardHome style={{ marginBottom: vs(50), width: scale(330) }}>
  <Text style={[styles.cardTitle,{color:palette.white}]}>Preferred Check-in Time *</Text>

  <Text style={[styles.cardSub,{color:palette.white}]}>
    Choose a time when your day is winding down and you can self-reflect without
    distractions. This is your moment to honestly assess your beliefs and track
    your reality shift progress.
  </Text>
  ...
  <View style={styles.row2}>
    <View style={styles.col}>
      <Text style={[styles.smallLabel,{color:palette.white}]}>Do Not Disturb Start</Text>
      <GradientDatePicker
        value={dndStart}
    ...
    <View style={styles.col}>
      <Text style={[styles.smallLabel,{color:palette.white}]}>Do Not Disturb End</Text>
      <GradientDatePicker
        value={dndEnd}
        onChange={setDndEnd}
        minimumDate={new Date()}
  ...
  <Text style={[styles.footNote,{color:palette.white}]}>
    ...
    preferred check-in time. No reminders will be sent during Do Not Disturb
    hours.
  </Text>
</GradientCardHome>
